...
<main>
  ...
  <section class="frontpage_hero">
    ...
    <iframe
      src="<?php the_field("hero_on_frontpage") ?>?autoplay=1&controls=0&mute=1&disablekb=1&loop=1&playlist=<?php the_field("video_id")?>/" title="YouTube video player" frameborder="0"
