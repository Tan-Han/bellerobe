...
{
  wp_enqueue_style("bellerobe-style", get_template_directory_uri() . "/style.css"); // Linking stylesheets
...
add_action('woocommerce_before_main_content', 'add_category_title', 15);
